...
export default function NavbarDetailKecamatan({ kecamatanName = "KECAMATAN" }) {
  ...
  return (
    <div className="w-full bg-[#bae6fd] px-4 py-2 sm:px-6 md:px-12 md:py-4 flex flex-col sm:flex-row justify-between items-center z-50 border-b-2 border-white/50 shadow-sm gap-3 sm:gap-0 sticky top-0">
      ...
      <div className="w-full sm:w-auto flex gap-2 justify-end items-center mt-2 sm:mt-0">
        ...
        <Link to="/" className="bg-blue-600 hover:bg-blue-700 text-white pl-2 pr-4 md:pr-5 py-1.5 md:py-2 rounded-full font-bold shadow-md shadow-blue-500/30 transition-all flex items-center gap-2 text-sm md:text-base group whitespace-nowrap">
