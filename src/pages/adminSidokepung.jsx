...
import DataTable from "../components/SidokepungTable/DataTable";
import FormModal from "../components/SidokepungTable/FormModal";
import DeleteModal from "../components/SidokepungTable/DeleteModal";
import UploadModal from "../components/SidokepungTable/UploadModal";
// Hooks
...
} from "../components/SidokepungTable/option";

const AdminSidokepung = () => {
  ...
  return (
    <div className="min-h-screen bg-[#ADD8E6] p-4">
      {/* Header */}
